...
const Account = {
    ...
    forgotpassword: (email: any) => requests.post('account/forgotpassword', email),
    resetpassword: (data: any) => requests.post('account/reset-password', data),
    logingoogle: (data: any) => requests.post('account/authenticate-google', data),
}
